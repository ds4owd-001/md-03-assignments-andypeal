...
3.  How many variables are in the data set? 8 columns = 8 variables
...
1.  Look at the plot that you created. What do you notice about the order of the bars / order of the legend? A: It is a ladder - going from poor to good sanitation.
2.  What would you want to change? A: Swap Unimproved and no sanitation facilities
3.  Why did we remove "safely managed sanitation services" from the data set in Task 3? A: Very few countries have safely managed sanitation

## Task 7

1.  Run the code in the code chunk below.
2.  What do you observe when you look at the code and plot? A: a - The y-axis scales are different in each b - Only 2020 data c - Includes safely managed
