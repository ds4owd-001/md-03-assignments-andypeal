...
3.  How many variables are in the data set? A: 8
4.  How many observations are in the data set? A: 8\*344 = 2,752
5.  What data types are contained in the variables? A: categorical, continuous, discrete (Reminder: <https://ds4owd-001.github.io/website/slides/lec-02-visualisation.html#/types-of-variables>)
